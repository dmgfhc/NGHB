...
namespace CG
{
    public partial class WGC2040C : CommonClass.FORMBASE
    {
        public WGC2040C()
        {
            InitializeComponent();
        ...
        protected override void p_SubFormInit()
        {
            ...
            p_SetMc("实绩状态", TXT_REC_STS, "R", "", "", "", "", imcseq);
            p_SetMc("仪器型号", f4ETCR_UST_EQPM, "NI", "", "", "", "", imcseq);
            p_SetMc("探伤指示标准", f4ETCR_UST_FL_ORD, "RL", "", "", "", "", imcseq);
            p_SetMc("探伤实绩标准", f4ETCR_UST_FL, "RNI", "4", "", "", "", imcseq);
            p_SetMc("探伤判定结果", TXT_UST_DEC, "RNI", "", "", "", "", imcseq);
            //6-10
            ...
            p_SetMc("实绩厚度", SDB_ORG_THK, "R", "", "", "", "", imcseq);
            p_SetMc("实绩宽度", SDB_ORG_WID, "R", "", "", "", "", imcseq);
            p_SetMc("实绩长度", SDB_ORG_LEN, "R", "", "", "", "", imcseq);
            p_SetMc("实绩重量", SDB_ORG_WGT, "R", "", "", "", "", imcseq);
            //16-20
            ...
            //26-30
            p_SetMc("判定结果厚度", TXT_THK_GRD, "R", "", "", "", "", imcseq);
            p_SetMc("判定结果宽度", TXT_WID_GRD, "R", "", "", "", "", imcseq);
            p_SetMc("判定结果长度", TXT_LEN_GRD, "R", "", "", "", "", imcseq);
            p_SetMc("原始标准号", TXT_ORG_STDSPEC, "R", "", "", "", "", imcseq);
            p_SetMc("改判标准号", F4ETCN_STDSPEC, "I", "", "", "", "", imcseq);
            //31-35
            p_SetMc("改判原因", f4ETCR_CHG_GRD_RES, "RI", "3", "", "", "", imcseq);
            p_SetMc("责任单位", f4ETCR_CHG_GRD_DEP, "RI", "3", "", "", "", imcseq);
            p_SetMc("判废原因", f4ETCR_SCRAP, "RI", "1", "", "", "", imcseq);
            p_SetMc("余材原因", f4ETCN_WOO_RSN, "RI", "2", "", "", "", imcseq);
            p_SetMc("厚度附加值", SDB_THK_ADD, "R", "", "", "", "", imcseq);
            p_SetMc("返剪原因", f4ETCR_PLATE_CUT_REASON, "RI", "", "", "", "", imcseq);
            //36-40
            p_SetMc("垛位号", TXT_LOC, "I", "", "", "", "", imcseq);
            p_SetMc("备注", TXT_REMARK, "RI", "", "", "", "", imcseq);
            p_SetMc("探伤人员", TXT_EMP_CD, "NRI", "", "", "", "", imcseq);
            p_SetMc("探伤时间", MDATE_UST_DATE, "NRI", "19", "", "", "", imcseq);
        ...
        {
            TXT_UST_DEC.Text = Convert.ToString(LISTB_UST_DEC.SelectedItem).Substring(0, 1);
        }
        #endregion
