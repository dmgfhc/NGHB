...
namespace CG
{
    public partial class WGB1060C : CommonClass.FORMBASE
    {
        public WGB1060C()
        {
            InitializeComponent();
        ...
        protected override void p_SubFormInit()
        {
           ...
           // p_SetMc("冷床", txt_bed_fl, "PNIR", "", "", "", "", imcseq);
            ...
            //8-9
            p_SetSc("上冷床时间", "DT", "19", "L", "", "", "", iscseq, iheadrow);          
            p_SetSc("上冷床温度", "N", "4", "L", "", "", "", iscseq, iheadrow);
            //10-11
            p_SetSc("下冷床时间", "DT", "19", "L", "", "", "", iscseq, iheadrow);            
            p_SetSc("下冷床温度", "N", "4", "L", "", "", "", iscseq, iheadrow);
            iheadrow = 0;
            p_spanSpread("1号上冷床", 8, 9, iscseq, iheadrow, 1);
            p_spanSpread("1号下冷床", 10,11, iscseq, iheadrow, 1);
        ...
        private void WGB1060C_Load(object sender, EventArgs e)
        {
            Form_Define();
