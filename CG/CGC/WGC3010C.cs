...
namespace CG
{
    public partial class WGC3010C : CommonClass.FORMBASE
    {
        public WGC3010C()
        {
            InitializeComponent();
        ...
        protected override void p_SubFormInit()
        {
            ...
            p_SetMc("厚度", SDB_THK_R, "P", "", "", "", "", imcseq);
            p_SetMc("宽度", SDB_WID_R, "P", "", "", "", "", imcseq);
         ...
         //   p_SetMc("上表小缺陷1名称", TXT_T_FLAW_NAME1, "L", "", "", "", "", imcseq);
            ...
            //26-30
            p_SetMc("订单重量", SDB_ORD_WGT, "R", "", "", "", "", imcseq);
            ...
            p_SetMc("厚度判定", TXT_THK_GRD, "R", "", "", "", "", imcseq);
            p_SetMc("宽度判定", TXT_WID_GRD, "R", "", "", "", "", imcseq);
            p_SetMc("长度判定", TXT_LEN_GRD, "R", "", "", "", "", imcseq);
            //36-40
            p_SetMc("定尺", f4ETCR_SIZE_KND, "IR", "", "", "", "", imcseq);
        ...
        public override void Form_Pro()
        {
            ...
            //确保修磨时间已经输入
            if (MDATE_GRID_DATE.Text == "    -  -     :  :" && checkBox1.Checked == true)
            {
       ...
       (GeneralCommon.M_CN1, "SELECT CD_SHORT_NAME FROM ZP_CD T WHERE CD_MANA_NO = 'G0002' AND T.CD =" + "'" + f4ETCR_CHG_GRD_RES.Text + "'");
        ...
        private void checkBox1_CheckedChanged(object sender, EventArgs e)
        {
            if (checkBox1.Checked == false)
            {
                ...
                TXT_T_GRID_GRD.Text = "";
                SDB_T_GRID_YRD.Text = "";
                SDB_T_GRID_DEEP.Text = "";
                TXT_B_GRID_GRD.Text = "";
                SDB_B_GRID_YRD.Text = "";
                SDB_B_GRID_DEEP.Text = "";
                MDATE_GRID_DATE.Text = "";
                LISTB_T_GRID_GRD.Text = "";
                LISTB_B_GRID_GRD.Text = "";
                MDATE_GRID_DATE.Text = "";

                LISTB_T_GRID_GRD.SetSelected(0, false);
                LISTB_B_GRID_GRD.SetSelected(0, false);

            }
            else if (checkBox1.Checked == true)
            {
                TXT_T_GRID_GRD.Enabled = true;
                SDB_T_GRID_YRD.Enabled = true;
                SDB_T_GRID_DEEP.Enabled = true;
                TXT_B_GRID_GRD.Enabled = true;
                SDB_B_GRID_YRD.Enabled = true;
                SDB_B_GRID_DEEP.Enabled = true;
                MDATE_GRID_DATE.Enabled = true;
                LISTB_T_GRID_GRD.Enabled = true;
                LISTB_B_GRID_GRD.Enabled = true;
                MDATE_GRID_DATE.Enabled = true;
                MDATE_GRID_DATE.Text = DateTime.Now.ToString();
                LISTB_T_GRID_GRD.SetSelected(0,true);
                LISTB_B_GRID_GRD.SetSelected(0, true);
                TXT_T_GRID_GRD.Text = "Y";
                TXT_B_GRID_GRD.Text = "Y";
            }
