...
namespace CG
{
    public partial class CGF2031C : CommonClass.FORMBASE
    {
        public CGF2031C()
        {
            InitializeComponent();
        ...
        protected override void p_SubFormInit()
        {
            ...
            p_SetMc("班别", CBO_GROUP, "NI", "", "", "", "", imcseq); //2
            p_SetMc("作业人员", TXT_ROLL_IN_EMP, "NI", "", "", "", "", imcseq); //3
            p_SetMc("", UTP_B_ROLL_USE_TIME, "R", "", "", "", "", imcseq); //4
            p_SetMc("", UTP_B_ROLL_IN_TIME, "NIR", "", "", "", "", imcseq); //5
            p_SetMc("", TXT_CHOCK_NO, "R", "", "", "", "", imcseq); //6
            p_SetMc("", SDB_B_PLANK_DATE, "IR", "", "", "", "", imcseq); //7
            p_SetMc("", SDB_B_PLANK_VAL, "IR", "", "", "", "", imcseq); //8
            p_SetMc("", TXT_B_SHIFT, "RL", "", "", "", "", imcseq); //9
            p_SetMc("", TXT_B_GROUP, "RL", "", "", "", "", imcseq); //10
            p_SetMc("", TXT_B_IN_EMP, "RL", "", "", "", "", imcseq); //11
            ...
            p_SetMc("班别", CBO_GROUP, "NI", "", "", "", "", imcseq); //2
            p_SetMc("作业人员", TXT_ROLL_IN_EMP, "NI", "", "", "", "", imcseq); //3
            p_SetMc("", UTP_C_ROLL_IN_TIME, "NIR", "", "", "", "", imcseq); //4
            p_SetMc("", TXT_BEAR_NO, "R", "", "", "", "", imcseq); //5
            p_SetMc("", TXT_C_ROLL_MOT, "IR", "", "", "", "", imcseq); //6
            ...
            p_SetMc("班别", CBO_GROUP, "NI", "", "", "", "", imcseq); //2
            p_SetMc("作业人员", TXT_ROLL_IN_EMP, "NI", "", "", "", "", imcseq); //3
            p_SetMc("", UTP_P_ROLL_IN_TIME, "NIR", "", "", "", "", imcseq); //4
            p_SetMc("", TXT_PLANK_NO, "NIR", "", "", "", "", imcseq); //5
            p_SetMc("", TXT_P_SHIFT, "RL", "", "", "", "", imcseq); //6
            p_SetMc("", TXT_P_GROUP, "RL", "", "", "", "", imcseq); //7
            p_SetMc("", TXT_P_IN_EMP, "RL", "", "", "", "", imcseq); //8
