...
//-- Program Name      轧辊使用情况查询(按时间)_CGF2070C
//-- Program ID        CGF2070C
...
//   1.00     2017.08.14       韩超        轧辊使用情况查询(按时间)_CGF2070C
//-------------------------------------------------------------------------------
//-- DECLARATION     ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//-------------------------------------------------------------------------------
...
namespace CG
{
    public partial class CGF2070C : CommonClass.FORMBASE
    {
        public CGF2070C()
        {
            InitializeComponent();
        ...
        protected override void p_SubFormInit()
        {
            ...
            p_McIni(Mc1, false);
            imcseq = 1;
            p_SetMc(SDT_PROD_DATE, "P", "", "", "", imcseq, "");
            p_SetMc(SDT_PROD_TO_DATE, "P", "", "", "", imcseq, "");
            ...
            p_SetSc("轧辊号", "E", "10", "L", "", "", "", iscseq, iheadrow, "M");//0
            p_SetSc("开始使用时间", "DT", "", "L", "", "", "", iscseq, iheadrow, "M");//1
            p_SetSc("结束使用时间", "DT", "", "L", "", "", "", iscseq, iheadrow, "M");//2
            p_SetSc("使用持续时间", "E", "60", "L", "", "", "", iscseq, iheadrow, "R");//3
            p_SetSc("辊身直径", "E", "60", "L", "", "", "", iscseq, iheadrow, "R");//4
            p_SetSc("辊颈直径", "E", "60", "L", "", "", "", iscseq, iheadrow, "R");//5
            p_SetSc("轧制重量", "E", "60", "L", "", "", "", iscseq, iheadrow, "R");//6
            p_SetSc("轧制板坯数", "E", "60", "L", "", "", "", iscseq, iheadrow, "R");//7
            p_SetSc("轧制公里数", "E", "60", "L", "", "", "", iscseq, iheadrow, "R");//8
            p_SetSc("辊型曲线", "E", "60", "L", "", "", "", iscseq, iheadrow, "L");//9
            p_SetSc("轧辊凸度", "E", "60", "L", "", "", "", iscseq, iheadrow, "R");//10
            p_SetSc("轧辊材质代码", "E", "60", "L", "", "", "", iscseq, iheadrow, "L");//11
            p_SetSc("轧辊制造编号", "E", "60", "L", "", "", "", iscseq, iheadrow, "L");//12
            p_SetSc("供货商代码", "E", "60", "L", "", "", "", iscseq, iheadrow, "L");//13
            p_SetSc("配辊号", "E", "60", "L", "", "", "", iscseq, iheadrow, "M");//14
            p_SetSc("SEQNO", "E", "20", "L", "", "", "", iscseq, iheadrow, "M");//15

        }

        public void Form_Load(object sender, System.EventArgs e)
        {
            base.sSvrPgmPkgName = "CGF2070NC";
            Form_Define();
