namespace CG
{
    partial class CGD2070C
    {
        ...
        private void InitializeComponent()
        {
            ...
            bControlFiledSetting12.TargetControl = this.txt_plt;
            bControlFiledSetting14.ColumnID = "CD_SHORT_NAME";
            bControlFiledSetting14.TargetControl = this.txt_plt_name;
            this.txt_plt.CustomSetting.Add(bControlFiledSetting12);
            this.txt_plt.CustomSetting.Add(bControlFiledSetting14);
    ...
    "D         like \'%\'  ORDER  BY  CD  ASC ";
            ...
            bControlFiledSetting2.TargetControl = this.txt_cur_inv_code;
            this.txt_cur_inv_code.CustomSetting.Add(bControlFiledSetting2);
    ...
    "QP_STD_HEAD T WHERE NVL(T.STDSPEC_CHR_CD,\'Y\') <>\'N\' ORDER BY STDSPEC ASC";
            ...
            bControlFiledSetting11.TargetControl = this.txt_UST;
            this.txt_UST.CustomSetting.Add(bControlFiledSetting11);
            ...
            bControlFiledSetting10.TargetControl = this.txt_SB;
            this.txt_SB.CustomSetting.Add(bControlFiledSetting10);
    ...
    "D         like \'%\'  ORDER  BY  CD  ASC ";
            ...
            bControlFiledSetting9.TargetControl = this.TXT_SPEC_PROC;
            this.TXT_SPEC_PROC.CustomSetting.Add(bControlFiledSetting9);
    ...
    "D         like \'%\'  ORDER  BY  CD  ASC ";
            ...
            bControlFiledSetting8.TargetControl = this.txt_HTM_METH1;
            this.txt_HTM_METH1.CustomSetting.Add(bControlFiledSetting8);
    ...
    "D         like \'%\'  ORDER  BY  CD  ASC ";
            ...
            bControlFiledSetting7.TargetControl = this.txt_HTM_COND1;
            this.txt_HTM_COND1.CustomSetting.Add(bControlFiledSetting7);
            ...
            bControlFiledSetting5.TargetControl = this.txt_HTM_COND2;
            this.txt_HTM_COND2.CustomSetting.Add(bControlFiledSetting5);
    ...
    "D         like \'%\'  ORDER  BY  CD  ASC ";
            ...
            // txt_HTM_COND3
            // 
            bControlFiledSetting13.ColumnID = "CD";
            bControlFiledSetting13.TargetControl = this.txt_HTM_COND3;
            this.txt_HTM_COND3.CustomSetting.Add(bControlFiledSetting13);
            ...
            bControlFiledSetting4.TargetControl = this.txt_HTM_METH3;
            this.txt_HTM_METH3.CustomSetting.Add(bControlFiledSetting4);
    ...
    "D         like \'%\'  ORDER  BY  CD  ASC ";
        ...
        private System.Windows.Forms.TextBox Text1_PLATE_NO;
        ...
        private CommonClass.F4ETCR TXT_SPEC_PROC;
        private CommonClass.F4ETCR txt_SB;
        private CommonClass.F4ETCR txt_UST;
        private System.Windows.Forms.CheckBox chk_can2;
