...
namespace CK
{
	public class MainMenu : System.Windows.Forms.Form
	{
        ...
        private MenuItem CKH2010C;
        private MenuItem CKG2070C;
        private MenuItem CKP1010C;
		...
		[System.Diagnostics.DebuggerStepThrough()]private void InitializeComponent()
		{
            ...
            this.CKG2040C = new System.Windows.Forms.MenuItem();
            this.CKG2020C = new System.Windows.Forms.MenuItem();
            this.CKG2030C = new System.Windows.Forms.MenuItem();
            this.CKH2010C = new System.Windows.Forms.MenuItem();
            this.CKG2070C = new System.Windows.Forms.MenuItem();
            this.menuItem12 = new System.Windows.Forms.MenuItem();
            this.CKP1010C = new System.Windows.Forms.MenuItem();
            ...
            // CKG2040C
            // 
            this.CKG2040C.Index = 1;
            resources.ApplyResources(this.CKG2040C, "CKG2040C");
            this.CKG2040C.Click += new System.EventHandler(this.CKG2040C_Click);
            // 
            // CKG2020C
            // 
            this.CKG2020C.Index = 2;
            resources.ApplyResources(this.CKG2020C, "CKG2020C");
            this.CKG2020C.Click += new System.EventHandler(this.CKG2020C_Click);
            // 
            // CKG2030C
            // 
            this.CKG2030C.Index = 3;
            resources.ApplyResources(this.CKG2030C, "CKG2030C");
            this.CKG2030C.Click += new System.EventHandler(this.CKG2030C_Click);
            // 
            // CKH2010C
            // 
            this.CKH2010C.Index = 4;
            resources.ApplyResources(this.CKH2010C, "CKH2010C");
            this.CKH2010C.Click += new System.EventHandler(this.CKH2010C_Click);
            // 
            // CKG2070C
            // 
            this.CKG2070C.Index = 5;
            resources.ApplyResources(this.CKG2070C, "CKG2070C");
            this.CKG2070C.Click += new System.EventHandler(this.CKG2070C_Click);
            // 
            // menuItem12
            // 
            ...
            // CKP1010C
            // 
            this.CKP1010C.Index = 0;
            resources.ApplyResources(this.CKP1010C, "CKP1010C");
            this.CKP1010C.Click += new System.EventHandler(this.CKP1010C_Click);
            // 
            // CKG2060C
            // 
            this.CKG2060C.Index = 1;
            resources.ApplyResources(this.CKG2060C, "CKG2060C");
            this.CKG2060C.Click += new System.EventHandler(this.CKG2060C_Click);
            // 
            // CKP1310C
            // 
            this.CKP1310C.Index = 2;
            resources.ApplyResources(this.CKP1310C, "CKP1310C");
            this.CKP1310C.Click += new System.EventHandler(this.CKP1310C_Click);
            // 
            // CKP1312C
            // 
            this.CKP1312C.Index = 3;
        ...
        private void CKG2040C_Click(object sender, EventArgs e)
        {
            if (!GeneralCommon.Gf_IsFormLoad("CKG2040C"))
            {
                CKG2040C CKG2040C = new CKG2040C();
                CKG2040C.MdiParent = this;
                CKG2040C.Show();
                CKG2040C.WindowState = FormWindowState.Maximized;

            }
        }

        private void CKG2020C_Click(object sender, EventArgs e)
        {
            if (!GeneralCommon.Gf_IsFormLoad("CKG2020C"))
            {
                CKG2020C CKG2020C = new CKG2020C();
                CKG2020C.MdiParent = this;
                CKG2020C.Show();
                CKG2020C.WindowState = FormWindowState.Maximized;
        ...
        private void CKH2010C_Click(object sender, EventArgs e)
        {
            if (!GeneralCommon.Gf_IsFormLoad("CKH2010C"))
            {
                CKH2010C CKH2010C = new CKH2010C();
                CKH2010C.MdiParent = this;
                CKH2010C.Show();
                CKH2010C.WindowState = FormWindowState.Maximized;

            }
        }

        private void CKG2070C_Click(object sender, EventArgs e)
        {
            if (!GeneralCommon.Gf_IsFormLoad("CKG2070C"))
            {
                CKG2070C CKG2070C = new CKG2070C();
                CKG2070C.MdiParent = this;
                CKG2070C.Show();
                CKG2070C.WindowState = FormWindowState.Maximized;

            }
        }

        private void CKP1010C_Click(object sender, EventArgs e)
        {
            if (!GeneralCommon.Gf_IsFormLoad("CKP1010C"))
            {
                CKP1010C CKP1010C = new CKP1010C();
                CKP1010C.MdiParent = this;
                CKP1010C.Show();
                CKP1010C.WindowState = FormWindowState.Maximized;

            }
        }

        private void CKG2060C_Click(object sender, EventArgs e)
        {
            if (!GeneralCommon.Gf_IsFormLoad("CKG2060C"))
            {
                CKG2060C CKG2060C = new CKG2060C();
                CKG2060C.MdiParent = this;
                CKG2060C.Show();
                CKG2060C.WindowState = FormWindowState.Maximized;

            }
        }

        private void CKP1310C_Click(object sender, EventArgs e)
        {
            if (!GeneralCommon.Gf_IsFormLoad("CKP1310C"))
            {
                CKP1310C CKP1310C = new CKP1310C();
                CKP1310C.MdiParent = this;
                CKP1310C.Show();
                CKP1310C.WindowState = FormWindowState.Maximized;

            }
        }

        private void CKP1312C_Click(object sender, EventArgs e)
        {
            if (!GeneralCommon.Gf_IsFormLoad("CKP1312C"))
            {
                CKP1312C CKP1312C = new CKP1312C();
