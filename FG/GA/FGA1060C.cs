...
namespace FG
{
    public partial class FGA1060C : CommonClass.FORMBASE
    {
        public FGA1060C()
        {
            InitializeComponent();
        ...
        protected override void p_SubFormInit()
        {
            ...
            p_McIni(Mc1, false);
            imcseq = 1;
            p_SetMc(TXT_PRC, "P", "", "", "", imcseq, "");  // 轧制序号
            p_SetMc(TXT_PRCLINE, "P", "", "", "", imcseq, "");      // 起始板坯号
            p_SetMc(SDT_PROD_DATE_FROM, "P", "", "", "", imcseq, "");        // 终止板坯号
            p_SetMc(SDT_PROD_DATE_TO, "P", "", "", "", imcseq, "");    // 目标板坯号
            p_SetMc(TXT_MAT_NO, "P", "", "", "", imcseq, "");    // 目标板坯号

            p_McIni(Mc2, false);
            imcseq = 2;
            p_SetMc("压平时间", TXT_DISCHARGE_TIME, "", "", "", "", "", imcseq);
            ...
            p_SetSc("入口测压下量", "N", "3", "I", "", "", "", iscseq, iheadrow, "R");//1
            p_SetSc("出口测压下量", "N", "3", "I", "", "", "", iscseq, iheadrow, "R");//2
            p_SetSc("倾斜度", "N", "3", "I", "", "", "", iscseq, iheadrow,"R");//3
            p_SetSc("压平道次", "E", "5", "I", "", "", "", iscseq, iheadrow, "R");//4
            p_SetSc("压平时间", "DT", "", "I", "", "", "", iscseq, iheadrow, "M");//5
            p_SetSc("压平速度", "N", "8,4", "I", "", "", "", iscseq, iheadrow, "R");//6
            p_SetSc("压平温度", "N", "6,2", "I", "", "", "", iscseq, iheadrow, "R");//7
            p_SetSc("班次", "E", "1", "I", "", "", "", iscseq, iheadrow, "M");//8
            p_SetSc("作业人员", "E", "10", "I", "", "", "", iscseq, iheadrow, "M");//9
            p_SetSc("压平次数", "N", "3", "L", "", "", "", iscseq, iheadrow, "R");//10
            p_SetSc("最后压平时间", "DT", "", "L", "", "", "", iscseq, iheadrow, "M");//11
            p_SetSc("热处理指示/实绩", "E", "60", "L", "", "", "", iscseq, iheadrow, "M");//12
            p_SetSc("标准号", "E", "30", "L", "", "", "", iscseq, iheadrow, "M");//13
            p_SetSc("厚度", "N", "6,2", "L", "", "", "", iscseq, iheadrow, "R");//14
            p_SetSc("宽厚", "N", "6,2", "L", "", "", "", iscseq, iheadrow, "R");//15
            p_SetSc("长度", "N", "6,2", "L", "", "", "", iscseq, iheadrow, "R");//16
            p_SetSc("重量", "N", "6,2", "L", "", "", "", iscseq, iheadrow, "R");//17
            p_SetSc("垛位", "E", "10", "L", "", "", "", iscseq, iheadrow, "M");//18
            p_SetSc("探伤指示/实绩", "E", "50", "L", "", "", "", iscseq, iheadrow, "M");//19
            p_SetSc("PRC", "E", "10", "I", "", "", "", iscseq, iheadrow, "M");//20
            p_SetSc("PRC_LINE", "E", "1", "I", "", "", "", iscseq, iheadrow, "M");//21
            p_SetSc("机座号", "E", "1", "I", "", "", "", iscseq, iheadrow, "M");//22
            p_SetSc("备注", "E", "100", "L", "", "", "", iscseq, iheadrow);//23
            p_SetSc("轧批号", "E", "14", "L", "", "", "", iscseq, iheadrow);//24
        ...
        private void TXT_DISCHARGE_TIME_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                if (this.ss1.ActiveSheet.RowHeader.Cells[lRow, 0].Text == "修改" || this.ss1.ActiveSheet.RowHeader.Cells[lRow, 0].Text== "增加")
                {
                    ss1.ActiveSheet.Cells[lRow, SPD_TIME].Text = TXT_DISCHARGE_TIME.Text;
        ...
        private void FGA1060C_Load(object sender, EventArgs e)
        {
            Form_Define();
            TXT_PRCLINE.Text = "1";
            TXT_PRC.Text = "P";
